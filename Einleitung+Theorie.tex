...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=0.9]{Altes_Wirbelbett_oben.png}
...
\begin{center}
	\captionof{table}[Gasströme zufällige Packung]{Gasströme [l/h] für $\epsilon = \SI{0,54}{}$ (zufällige Packung)}
		\vspace{0.25cm}
...
\begin{center}
		\captionof{table}[Gasströme komprimierte Packung]{Gasströme [l/h] für $\epsilon = \SI{0,64}{}$ (leicht komprimiert)}
			\vspace{0.25cm}
	\begin{tabular}{|c|S|S|S|S|}
		\hline
		\diagbox{$D_r$ $[mm]$}{$d_p$ $[\mu m]$}    & 300   & 500   & 750   & 1000 \\
