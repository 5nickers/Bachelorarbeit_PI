...
Aus mehreren Gründen entschied man sich für einen Massenstromregler der Firma Brooks: \\
...
\begin{figure}[h!]
	\begin{center}
		...
		\caption[Gassystem montiert]{Zusammenbau Gassystem. Man sieht den Massenstromregler von dem die Luft in das Gassystem geleitet wird. Nun kann über die Kükenhähne entschieden werden, ob die Luft über den Luftbefeuchter oder daran vorbei fließen soll. Mittig unten ist der Drucksensor und der Bunaschlauch mit dem das Wirbelbett angeschlossen wird.}
	\end{center}
\end{figure}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=0.52]{Messmethode_Anpressung.png}
...
Zudem stellte sich während der Messungen heraus, dass der verwendete Luftionisator (Haug Static Line LC) nicht den gewünschten Effekt erzielt. Daher wurde dieser Anschluss bei der Ausführung in Aluminium ebenfalls weggelassen. Um den Anschlusszylinder trotzdem mit dem Justiermechanismus zu verbinden, wird dieser Teil weiterhin im 3D Drucker gedruckt und anschließend mit zwei Komponentenkleber (UHU Plus, 2-K-Epoxidkleber) an den Anschlusszylinder angeklebt.
...
\subparagraph{Anpassungen an den gefräßten Anschlusszylinder}
\hfill \\
...
In der Aufsicht sieht man, dass zum Verschieben nach links und rechts zwei durch eine Laborklemme (rot) gegeneinander verschiebbare Träger genutzt wurden. Am Ende des linken Trägers wurde mittels zweier Winkel die Halteplatte für das Wirbelbett montiert.
...
Man sieht ganz deutlich den Peak (ca \SI{340}{l/h}), an dem das Granulat vom festen in den fluidisierten Zustand übergeht und anschließend in den Bubbling Zustand (ca \SIrange{400}{900}{l/h}), in dem die Druckdifferenz konstant bleibt. Im Bereich des Bubblings fluktuieren die Werte recht stark, da sich das Granulat stark auf und ab bewegt und so eine variierenden Gegenkraft ausübt. 
...
Man sieht, dass der Peak wie erwartet, bei einer Beschichtung der Partikel mit einem Aerosol, kleiner ausfällt. Das liegt an der reduzierten Reibung der Partikel untereinander. Die theoretische Kurve hat überhaupt keinen Peak mehr, sondern einen übergangslosen Wechsel vom festen in den flüssigen Zustand. 
...
Wenn man das Wirbelbett, zur Unterdrückung der Elektrostatik, mit dem Luftbefeuchter betreibt, dann sieht die Kurve wie folgt aus: 
...
Man erkennt, dass der Peak deutlich ausgeprägter ist. Dadurch kann man den Breaking Point genauer bestimmen.
