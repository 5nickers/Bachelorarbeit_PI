...
Insgesamt wurden Zukaufteile im Wert von gut \SI{1600}{\euro} identifiziert. Eine genaue Aufstellung ist im folgenden zu sehen:
...
\begin{figure}[h]
	\begin{center}
		...
		\caption[Modell Wirbelbett]{vollständig zusammengebautes Wirbelbett im betriebsbereiten Zustand/ noch neues Bild machen}
	\end{center}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.7]{Adapter_Ionisator.png}
		\caption[Adapter für Ionisator]{3D Duck Ionisatoradapter. Der Adapter wird auf den Ionisator geklebt und anschließend in den Anschlusszylinder eingedreht. Dabei drückt der hervorstehende Ring in die Nut des Anschlusszylinders}
	\end{center}
\end{figure}
...
\begin{align*}
	...
	F_{res} &= \frac{\SI{2,5}{Nm}}{0,25 \cdot \frac{\SI{4,773}{mm} + \SI{6}{mm}}{4} + \frac{\SI{5,35}{mm}}{2} \cdot \tan(\SI{3,405}{^\circ} + \SI{16,16}{^\circ})} = \SI{}{N}
\end{align*}

Bei sechs Schrauben erhält man eine Gesamtkraft von $F_{ges} = \SI{}{N}$. Das führt zu einer dichten Verbindung. Dabei ist darauf zu achten, das zwischen Röhrchenhalter und Anschlusszylinder ein Spalt \SI{2}{mm} bleibt. Dies schont die Dichtung und ist trotzdem luftdicht.
...
\begin{figure}[h]
	\begin{center}
	\includegraphics[scale=0.4]{Halterung_Labor_Seite.png}
...
\begin{figure}[h!]
	\begin{minipage}[hbt]{6.5cm}
		...
		\caption[Leck Röhrchenansatz vorher]{Übergang Röhrchenhalter - Röhrchen. Man sieht das keine neuen Blasen enstanden sind.}
	\end{minipage}
	\hfill
	\begin{minipage}[hbt]{7cm}
		\centering
		\includegraphics[width=7cm]{Leck2_nachher.jpg}
		\caption[Leck Anschlusszylinder vorher]{Übergang Anschlusszylinder - Röhrchenhalter. Es findet keine Blasenbildung statt.}
	\end{minipage}
\end{figure}
