...
Um die Anforderung der Erweiterung des Regelbereichs beim Gasstrom auf \SIrange{0}{3000}{l/h} zu erfüllen, musste der bisherige Flowcontroller mit einem Regelbereich von \SIrange{0}{120}{l/h} ersetzt werden. \\
...
Ursprünglich sollte der Luftbefeuchter so ausgelegt werden, sodass der gesamte Regelbereich des Controllers abgedeckt ist. In Versuchen hat sich allerdings gezeigt, das dafür ein Wasservolumen von \SIrange{7}{8}{l} nötig wäre. Eine Aperatur dieser Größe wäre schwer bis unmöglich im Lichtstreuaufbau unterzubringen. Daher wurde ein Behältnis, das in den Aufbau passt, gewählt und damit ist nun ein Flussbereich von \SIrange{0}{000}{l/h} abdeckbar. \\
...
Wie schon in der Einleitung beschrieben, hat ein granulares Medium mehrere Phasen gleichzeitig, von denen die oberste die Gasphase ist. Je nach Füllstand und Gasfluss des Messröhrchens kann es nun passieren, das einzelne Partikel oben aus dem Röhrchen hinausfliegen. Dies gilt es zu verhindern.
