...
\begin{align*}
	...
	F_{res} &= \frac{\SI{1,5}{Nm}}{0,25 \cdot \frac{\SI{4,773}{mm} + \SI{6}{mm}}{4} + \frac{\SI{5,35}{mm}}{2} \cdot \tan(\SI{3,405}{^\circ} + \SI{16,16}{^\circ})} = \SI{}{N}
\end{align*}

Bei sechs Schrauben erhält man eine Gesamtkraft von $F_{ges} = \SI{}{N}$. Das führt zu einer dichten Verbindung.
